...
Running
Have mp3 and or avi files in the same directory as the executable.
The program should list them
To Play double click on one of the media listed on the side.
Should automaticcaly cycle through in the order listed
